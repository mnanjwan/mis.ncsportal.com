...
class DcAdminQueryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboards.dc-admin.queries.index', compact('queries', 'officers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboards.dc-admin.queries.show', compact('query'));
    }
}
