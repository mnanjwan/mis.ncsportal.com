...
class SystemSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $settingsConfig = [
            ...
            'pass_max_days_gl07_above' => [
                'label' => 'Pass Max Working Days (GL 07 and Above)',
                'description' => 'Maximum working days for pass (Saturdays/Sundays excluded). Officers at GL 07 and above.',
                'type' => 'number',
                'default' => '30',
                'min' => 1,
                'max' => 60,
            ],
            'pass_max_days_gl04_06' => [
                'label' => 'Pass Max Working Days (GL 04 to GL 06)',
                'description' => 'Maximum working days for pass (Saturdays/Sundays excluded). Officers at GL 04, 05, 06.',
                'type' => 'number',
                'default' => '21',
                'min' => 1,
                'max' => 45,
            ],
            'pass_max_days_gl03_below' => [
                'label' => 'Pass Max Working Days (GL 03 and Below)',
                'description' => 'Maximum working days for pass (Saturdays/Sundays excluded). Officers at GL 03 and below.',
                'type' => 'number',
                'default' => '14',
                'min' => 1,
                'max' => 30,
            ...
            foreach ($validated['settings'] as $key => $value) {
                ...
                if (empty($setting->description)) {
                    $descriptions = [
                        ...
                        'pass_max_days_gl07_above' => 'Maximum working days for pass (GL 07 and above). Saturdays/Sundays excluded.',
                        'pass_max_days_gl04_06' => 'Maximum working days for pass (GL 04 to GL 06). Saturdays/Sundays excluded.',
                        'pass_max_days_gl03_below' => 'Maximum working days for pass (GL 03 and below). Saturdays/Sundays excluded.',
