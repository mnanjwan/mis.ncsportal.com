            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col md:flex-row gap-3 items-end">
                    ...
                    <div class="w-full md:w-48">
                        ...
                        <div class="relative">
                            <input type="hidden" id="filter-quartered" value="">
                            <button type="button" 
                                    id="quartered_select_trigger" 
                                    class="kt-input w-full text-left flex items-center justify-between cursor-pointer">
                                <span id="quartered_select_text">All Status</span>
                                <i class="ki-filled ki-down text-gray-400"></i>
                            </button>
                            <div id="quartered_dropdown" 
                                 class="absolute z-50 w-full mt-1 bg-white border border-input rounded-lg shadow-lg hidden">
                                <div class="p-3 border-b border-input">
                                    <input type="text" 
                                           id="quartered_search_input" 
                                           class="kt-input w-full pl-10" 
                                           placeholder="Search status..."
                                           autocomplete="off">
                                </div>
                                <div id="quartered_options" class="max-h-60 overflow-y-auto"></div>
                            </div>
                        </div>
                    </div>
...
// Initialize quartered status select on page load
document.addEventListener('DOMContentLoaded', function() {
    const quarteredOptions = [
        {id: '', name: 'All Status'},
        {id: '1', name: 'Quartered'},
        {id: '0', name: 'Not Quartered'}
    ];

    createSearchableSelect({
        triggerId: 'quartered_select_trigger',
        hiddenInputId: 'filter-quartered',
        dropdownId: 'quartered_dropdown',
        searchInputId: 'quartered_search_input',
        optionsContainerId: 'quartered_options',
        displayTextId: 'quartered_select_text',
        options: quarteredOptions,
