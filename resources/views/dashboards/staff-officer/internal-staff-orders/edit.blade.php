                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <select name="target_unit" 
                                ...
                                @foreach($availableUnits as $unit)
                                    <option value="{{ $unit }}" {{ old('target_unit', $order->target_unit) == $unit ? 'selected' : '' }}>
                                        {{ $unit }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <select name="target_role" 
                                ...
                                <option value="Member" {{ old('target_role', $order->target_role) == 'Member' ? 'selected' : '' }}>Member</option>
                                <option value="2IC" {{ old('target_role', $order->target_role) == '2IC' ? 'selected' : '' }}>2IC (Second In Command)</option>
                                <option value="OIC" {{ old('target_role', $order->target_role) == 'OIC' ? 'selected' : '' }}>OIC (Officer In Charge)</option>
                            </select>
