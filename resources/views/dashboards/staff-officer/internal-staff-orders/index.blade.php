                                ...
                                @forelse($orders as $order)
                                    <tr class="border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                                        ...
                                        <td class="py-3 px-4">
                                            @if($order->officer)
                                                <span class="text-sm text-foreground">
                                                    {{ $order->officer->initials }} {{ $order->officer->surname }}<br>
                                        ...
                                        <td class="py-3 px-4">
                                            ...
                                            @else
                                                <span class="kt-badge kt-badge-secondary">{{ $order->status ?? 'N/A' }}</span>
                                            @endif
                                        </td>
                                        <td class="py-3 px-4 text-sm text-secondary-foreground">
                                        ...
                                        <td class="py-3 px-4 text-right">
                                            <div class="flex items-center justify-end gap-2">
                                                ...
                                                <button type="button" 
                                                        ...
                                                        title="Delete"
                                                        data-kt-modal-toggle="#delete-order-modal-{{ $order->id }}">
                            ...
                            <div class="kt-card-content p-4">
                                ...
                                @if($order->officer)
                                    <p class="text-sm text-foreground mb-2">
                                        <strong>Officer:</strong> {{ $order->officer->initials }} {{ $order->officer->surname }} ({{ $order->officer->service_number }})
                                    </p>
                                @endif
                                @if($order->target_unit)
                                    <p class="text-sm text-foreground mb-2">
                                        <strong>Target:</strong> {{ $order->target_unit }} @if($order->target_role)({{ $order->target_role }})@endif
                                    </p>
                                @endif
                                <div class="mb-3">
                                    @if($order->status === 'DRAFT')
                                ...
                                <div class="flex items-center gap-2 pt-3 border-t border-border">
                                    ...
                                    <div class="kt-modal" data-kt-modal="true" id="delete-order-modal-mobile-{{ $order->id }}">
                                        <div class="kt-modal-content max-w-[400px]">
                                            <div class="kt-modal-header py-4 px-5">
                                                <div class="flex items-center gap-3">
                                                    <div class="flex items-center justify-center size-10 rounded-full bg-danger/10">
