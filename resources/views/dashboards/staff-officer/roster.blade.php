            ...
            <div class="kt-card-content">
                @forelse($rosters as $roster)
                    <div class="flex items-center justify-between p-4 rounded-lg bg-muted/50 border border-input hover:bg-muted mb-4 last:mb-0">
                        ...
                        <div class="flex items-center gap-4">
                            <span class="kt-badge kt-badge-{{ strtolower($roster->status) === 'active' ? 'success' : 'warning' }} kt-badge-sm">
                                {{ $roster->status }}
                            </span>
                            <a href="{{ route('staff-officer.roster.show', $roster->id) }}" class="kt-btn kt-btn-sm kt-btn-ghost">
                                <i class="ki-filled ki-eye"></i> View
                            </a>
                            <a href="{{ route('staff-officer.roster.edit', $roster->id) }}" class="kt-btn kt-btn-sm kt-btn-primary">
