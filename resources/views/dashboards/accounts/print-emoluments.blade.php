    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="kt-card">
            ...
            <div class="kt-card-content">
                <form method="GET" action="{{ route('accounts.emoluments.print.view') }}" target="_blank" class="flex flex-col gap-4">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('accounts.emoluments.print') }}" class="kt-btn kt-btn-outline">
                            Clear Filters
                        </a>
                    </div>
                </form>
