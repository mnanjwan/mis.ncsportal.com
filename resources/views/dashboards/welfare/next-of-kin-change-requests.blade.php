...
@section('title', 'Next of KIN Change Requests')
@section('page-title', 'Next of KIN Change Requests')

@section('breadcrumbs')
    <a class="text-secondary-foreground hover:text-primary" href="{{ route('welfare.dashboard') }}">Welfare</a>
    <span>/</span>
    <span class="text-primary">Next of KIN Change Requests</span>
@endsection
    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="kt-card">
            <div class="kt-card-header">
                <h3 class="kt-card-title">Next of KIN Change Requests</h3>
            </div>
