        ...
        <div class="kt-card-content">
            ...
            <div class="border-t border-border pt-6 mt-6">
                <div class="flex gap-3">
                    <form action="{{ route('area-controller.manning-level.approve', $request->id) }}" method="POST" class="inline">
                        @csrf
                        <button type="submit" class="kt-btn kt-btn-success" onclick="return confirm('Approve this manning request?')">
