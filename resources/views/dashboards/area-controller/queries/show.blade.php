...
@section('breadcrumbs')
    ...
    <span>/</span>
    <a class="text-secondary-foreground hover:text-primary" href="{{ route('area-controller.queries.index') }}">Queries</a>
    <span>/</span>
        ...
        <div class="kt-card-content">
            <div class="grid gap-5">
                ...
                <div class="flex gap-3 pt-5 border-t border-border">
                    <a href="{{ route('area-controller.queries.index') }}" class="kt-btn kt-btn-secondary">
                        Back to List
                    </a>
                </div>
            </div>
