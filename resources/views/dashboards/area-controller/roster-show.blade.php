...
@section('breadcrumbs')
    ...
    <span>/</span>
    <a class="text-secondary-foreground hover:text-primary" href="{{ route('area-controller.roster') }}">Duty Rosters</a>
    <span>/</span>
...
<div class="grid gap-5 lg:gap-7.5">
    <div class="flex items-center justify-between">
        <a href="{{ route('area-controller.roster') }}" class="kt-btn kt-btn-sm kt-btn-ghost">
...
<div id="reject-modal" class="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50">
    <div class="kt-card max-w-md w-full mx-4">
        ...
        <form action="{{ route('area-controller.roster.reject', $roster->id) }}" method="POST" class="kt-card-content">
            @csrf
