...
@section('breadcrumbs')
    ...
    <span>/</span>
    <a class="text-secondary-foreground hover:text-primary" href="{{ route('area-controller.leave-pass', ['type' => 'leave']) }}">Leave & Pass</a>
    <span>/</span>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex-shrink-0 flex gap-2">
                @if($application->status === 'APPROVED')
                    <a href="{{ route('area-controller.leave-applications.print', $application->id) }}" 
                       class="kt-btn kt-btn-success" target="_blank">
                        <i class="ki-filled ki-printer"></i> Print
                    </a>
                @endif
                <a href="{{ route('area-controller.leave-pass', ['type' => 'leave']) }}" class="kt-btn kt-btn-outline">
