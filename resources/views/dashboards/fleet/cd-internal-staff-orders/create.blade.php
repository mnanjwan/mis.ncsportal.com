...
@section('title', 'Create Internal Staff Order (Transport)')
@section('page-title', 'Create Internal Staff Order (Transport)')
...
@section('content')
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('fleet.cd.internal-staff-orders.index') }}" class="kt-btn kt-btn-sm kt-btn-ghost">
        ...
        <div class="kt-card">
            <div class="kt-card-header">
                <h3 class="kt-card-title">Create Internal Staff Order (Transport Officers)</h3>
            </div>
            <div class="kt-card-content">
                <form action="{{ route('fleet.cd.internal-staff-orders.store') }}" method="POST" id="internalStaffOrderForm">
                    @csrf
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <span class="text-xs text-secondary-foreground">Select a Transport officer for this internal staff order.</span>
                            @error('officer_id')
                                <span class="text-sm text-danger">{{ $message }}</span>
                            @enderror
                        </div>
