                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <span class="text-xs text-secondary-foreground">
                                        Assessed: ${emol.assessed_at ? new Date(emol.assessed_at).toLocaleDateString() : 'N/A'}
                                    </span>
                                </div>
                            </div>
                            <div class="flex items-center gap-4">
                                <span class="kt-badge kt-badge-${statusColor} kt-badge-sm">${emol.status}</span>
                                ${emol.status === 'ASSESSED' ? `
                                    <a href="/validator/emoluments/${emol.id}/validate" class="kt-btn kt-btn-sm kt-btn-success">Validate</a>
                                ` : ''}
                                <a href="/validator/emoluments/${emol.id}" class="kt-btn kt-btn-sm kt-btn-ghost">View</a>
                            </div>
                        </div>
                    `;
                }).join('');
