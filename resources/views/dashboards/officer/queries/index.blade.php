...
<div class="grid gap-5 lg:gap-7.5">
    <div class="kt-card overflow-hidden">
        <div class="kt-card-header">
            <h3 class="kt-card-title">Query History</h3>
            <div class="kt-card-toolbar">
                <form method="GET" action="{{ route('officer.queries.index') }}" id="status-filter-form" class="inline">
                    <div class="relative">
                    ...
                    <table class="kt-table" style="min-width: 800px; width: 100%;">
                        <thead>
                            <tr class="border-b border-border">
                                <th class="text-left py-3 px-4 font-semibold text-sm">Issued By</th>
