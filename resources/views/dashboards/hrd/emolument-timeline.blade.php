...
@section('title', 'Emolument Timeline')
@section('page-title', 'Emolument Timeline')

@section('breadcrumbs')
    <a class="text-secondary-foreground hover:text-primary" href="{{ route('hrd.dashboard') }}">HRD</a>
    <span>/</span>
    <span class="text-primary">Emolument Timeline</span>
@endsection
...
<div class="grid gap-5 lg:gap-7.5">
    ...
    <div class="kt-card">
        <div class="kt-card-header">
            <h3 class="kt-card-title">Emolument Timelines</h3>
            <div class="kt-card-toolbar">
                <a href="{{ route('hrd.emolument-timeline.create') }}" class="kt-btn kt-btn-sm kt-btn-primary">
                                ...
                                <tr class="border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                                    ...
                                    <td class="py-3 px-4 text-right">
                                        @if($timeline->is_active)
                                            <a href="{{ route('hrd.emolument-timeline.extend', $timeline->id) }}" 
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="py-12 text-center">
                                        ...
                                        <a href="{{ route('hrd.emolument-timeline.create') }}" class="kt-btn kt-btn-primary">
