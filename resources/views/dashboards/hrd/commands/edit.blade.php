...
@section('page-title', 'Edit Command')
    ...
    <div class="grid gap-5 lg:gap-7.5">
        <div class="kt-card">
            <div class="kt-card-header">
                <h3 class="kt-card-title">Edit Command: {{ $command->name }}</h3>
            </div>
            <div class="kt-card-content">
                <form method="POST" action="{{ route('hrd.commands.update', $command->id) }}" class="flex flex-col gap-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="location" 
                               value="{{ old('location', $command->location) }}"
                    ...
                    <div class="flex items-center justify-end gap-2.5 pt-4 border-t border-border">
                        ...
                        <button type="submit" class="kt-btn kt-btn-primary">
                            <i class="ki-filled ki-check"></i> Update Command
                        </button>
                    </div>
                </form>
            </div>
