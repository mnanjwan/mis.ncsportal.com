...
@section('breadcrumbs')
    ...
    <span>/</span>
    <a class="text-secondary-foreground hover:text-primary" href="{{ route('hrd.queries.index') }}">Queries</a>
    <span>/</span>
        ...
        <div class="kt-card-content">
            <div class="grid gap-5">
                ...
                <div>
                    ...
                    <div class="kt-input bg-muted">
                        {{ $query->officer->presentStation->name ?? 'N/A' }}
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-5 border-t border-border">
                    <a href="{{ route('hrd.queries.index') }}" class="kt-btn kt-btn-secondary">
                        Back to List
                    </a>
                    <a href="{{ route('hrd.officers.show', $query->officer->id) }}" class="kt-btn kt-btn-primary">
