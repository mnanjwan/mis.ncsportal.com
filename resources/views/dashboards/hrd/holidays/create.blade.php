...
@section('breadcrumbs')
    ...
    <span>/</span>
    <span class="text-primary">Add Holiday</span>
@endsection
...
<div class="max-w-2xl">
    <div class="kt-card">
        <div class="kt-card-header">
            <h3 class="kt-card-title">New Holiday Configuration</h3>
        </div>
        <div class="kt-card-content p-5 lg:p-7.5">
            <form action="{{ route('hrd.holidays.store') }}" method="POST" class="flex flex-col gap-6">
                @csrf
                
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-medium text-foreground">Holiday Name</label>
                    <input type="text" name="name" class="kt-input" placeholder="e.g. Id-el-Fitr" required value="{{ old('name') }}">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="date" name="date" class="kt-input" required value="{{ old('date') }}">
                ...
                <div class="flex items-start gap-3 p-4 rounded-lg bg-muted/30 border border-input">
                    <input type="checkbox" name="is_floating" id="is_floating" class="kt-checkbox mt-1" checked value="1" {{ old('is_floating', '1') == '1' ? 'checked' : '' }}>
                ...
                <div class="flex justify-end gap-3 mt-4">
                    ...
                    <button type="submit" class="kt-btn kt-btn-primary">
                        <i class="ki-filled ki-check"></i> Save Holiday
                    </button>
                </div>
            </form>
        </div>
