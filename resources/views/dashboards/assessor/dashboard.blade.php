...
@section('breadcrumbs')
    <span class="text-primary">Assessor Dashboard</span>
@endsection
...
<div class="grid gap-5 lg:gap-7.5">
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-7.5">
            ...
            <div class="kt-card">
                <div class="kt-card-content flex flex-col gap-4 p-5 lg:p-7.5">
                    <div class="flex items-center justify-between">
                        <div class="flex flex-col gap-1">
                            <span class="text-sm font-normal text-secondary-foreground">Pending Assessment</span>
                            <span class="text-2xl font-semibold text-mono">{{ $pendingEmolumentsCount ?? 0 }}</span>
                        </div>
            ...
            <div class="kt-card">
                <div class="kt-card-content flex flex-col gap-4 p-5 lg:p-7.5">
                    <div class="flex items-center justify-between">
                        <div class="flex flex-col gap-1">
                            <span class="text-sm font-normal text-secondary-foreground">Assessed</span>
                            <span class="text-2xl font-semibold text-mono">{{ $assessedCount ?? 0 }}</span>
                        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
            <!-- Pending Emoluments for Assessment -->
            <div class="kt-card">
                <div class="kt-card-header">
                    <div class="flex items-center justify-between">
                        <h3 class="kt-card-title">Pending Emoluments for Assessment</h3>
                        <a href="{{ route('assessor.emoluments') }}" class="kt-btn kt-btn-sm kt-btn-ghost">
                            View All
                    ...
                    <div class="flex flex-col gap-4">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <span class="text-xs text-secondary-foreground">
                                            Submitted: {{ $emolument->submitted_at ? $emolument->submitted_at->format('d/m/Y H:i') : 'N/A' }}
                                        </span>
                                    </div>
                                </div>
                        ...
                        @empty
                            <div class="text-center py-12">
                                ...
                                <p class="text-secondary-foreground">No pending emoluments for assessment</p>
                                <p class="text-xs text-secondary-foreground mt-2">All emoluments from your command have been assessed</p>
                            </div>
                        @endforelse
                    </div>
                </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-medium text-foreground">Raised (Pending Assessment)</span>
                            </div>
                            <span class="kt-badge kt-badge-warning kt-badge-sm">{{ $emolumentStatus['RAISED'] ?? 0 }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                            <div class="flex items-center gap-3">
                            ...
                            <span class="kt-badge kt-badge-info kt-badge-sm">{{ $emolumentStatus['ASSESSED'] ?? 0 }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                            <div class="flex items-center gap-3">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
            ...
            <div class="kt-card">
                <div class="kt-card-header">
                    <div class="flex items-center justify-between">
                        <h3 class="kt-card-title">Recent Assessments</h3>
                        <a href="{{ route('assessor.emoluments') }}?status=ASSESSED" class="kt-btn kt-btn-sm kt-btn-ghost">
                            View All
                            <i class="ki-filled ki-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="kt-card-content">
                    <div class="flex flex-col gap-4">
                        @forelse($recentAssessments as $emolument)
                            <div class="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                                <div class="flex items-center gap-3">
                                    <div class="flex items-center justify-center size-10 rounded-full bg-success/10">
                                ...
                                <div class="flex flex-col items-end gap-0.5">
                                    <span class="kt-badge kt-badge-success kt-badge-sm">Assessed</span>
                                    <span class="text-xs text-secondary-foreground">
                                        {{ $emolument->assessment?->assessed_at ? $emolument->assessment->assessed_at->format('d/m/Y') : 'N/A' }}
                                    </span>
                                </div>
                            </div>
                        @empty
                            <p class="text-secondary-foreground text-center py-4">No recent assessments</p>
                        @endforelse
                    </div>
                </div>
            </div>
