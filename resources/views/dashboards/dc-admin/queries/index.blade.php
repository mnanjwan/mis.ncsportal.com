    ...
    <div class="kt-card overflow-hidden">
        <div class="kt-card-header">
            ...
            <div class="kt-card-toolbar">
                <form method="GET" action="{{ route('dc-admin.queries.index') }}" class="inline">
                    <select name="officer_id" class="kt-input" onchange="this.form.submit()">
                        ...
                        <tbody>
                            @foreach($queries as $query)
                                <tr class="border-b border-border last:border-0 hover:bg-muted/50">
                                    ...
                                    <td class="py-3 px-4">
                                        <a href="{{ route('dc-admin.queries.show', $query->id) }}" class="kt-btn kt-btn-sm kt-btn-primary">
                                            View Details
                                        </a>
                                    </td>
                                </tr>
