    ...
    <div class="kt-card-content">
        <div class="flex flex-col gap-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-muted/50 rounded-lg">
                <div>
                    <label class="kt-form-label">Period of Report - From</label>
                    <input type="date" name="period_from" class="kt-input" value="{{ old('period_from', $formData['period_from'] ?? '') }}">
                </div>
                <div>
                    <label class="kt-form-label">Period of Report - To</label>
            ...
            <div class="flex flex-col gap-1">
                <label class="kt-form-label">1. SERVICE NO</label>
            ...
            <!-- 2. Full Name -->
            <div class="flex flex-col gap-1">
                <label class="kt-form-label">2. Full name of officer (Block Letters) Surname First</label>
            ...
            <!-- 3(A). Personal Data -->
            <div class="flex flex-col gap-1">
                <label class="kt-form-label font-semibold">3(A). Personal Data</label>
            ...
            <div class="flex flex-col gap-1">
                <label class="kt-form-label font-semibold">3(B). Personal Particulars</label>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="kt-form-label text-sm">Date of 1st Appointment</label>
                    ...
                    <div>
                        <label class="kt-form-label text-sm">HAPASS</label>
