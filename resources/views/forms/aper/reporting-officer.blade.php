...
@section('breadcrumbs')
    ...
    <a class="text-secondary-foreground hover:text-primary"
        href="{{ route('staff-officer.aper-forms.reporting-officer.search') }}">APER Forms</a>
    <span>/</span>
...
@section('content')
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <!-- Form -->
        <form action="{{ route('staff-officer.aper-forms.update-reporting-officer', $form->id) }}" method="POST"
            ...
            <div class="kt-card">
                <div class="kt-card-content">
                    <div class="flex items-center justify-between pt-4 border-t border-border">
                        <a href="{{ route('staff-officer.aper-forms.reporting-officer.search') }}"
        ...
        <form id="complete-forward-form"
            action="{{ route('staff-officer.aper-forms.complete-reporting-officer', $form->id) }}" method="POST"
            style="display: none;">
            @csrf
        </form>
    </div>
            ...
            if (completeForwardBtn) {
                completeForwardBtn.addEventListener('click', function (e) {
                    ...
                    Swal.fire({
                        ...
                        text: 'Are you sure you want to complete and forward this assessment to Countersigning Officer?',
                        icon: 'warning',
