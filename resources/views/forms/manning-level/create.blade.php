...
@section('content')
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-5 lg:gap-9 mb-5 lg:mb-10">
        <div class="xl:col-span-2 space-y-5">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-col gap-1">
                            ...
                            <span class="text-xs text-secondary-foreground">
                                Submit a request for additional officers at your command. The request will be reviewed by
                                Area Controller.
                            </span>
                        </div>
                    </div>
            ...
            <!-- Form -->
            <form class="kt-card" id="create-manning-request-form" method="POST"
                action="{{ route('staff-officer.manning-level.store') }}">
                @csrf
                ...
                <div class="kt-card-content space-y-5">
                        ...
                        <div class="kt-card bg-warning/10 border border-warning/20">
                            <div class="kt-card-content p-4">
                                <p class="text-sm text-warning">
                                    <i class="ki-filled ki-information"></i> You are not assigned to a command. Please contact
                                    HRD for command assignment.
                                </p>
                            </div>
                        </div>
                    @else
                        <div class="flex flex-col gap-1">
                            <label class="kt-form-label font-normal text-mono">Command <span
                        ...
                        <div class="flex flex-col gap-1">
                            <label class="kt-form-label font-normal text-mono">Request Type <span
                                    class="text-danger">*</span></label>
                            <div class="relative">
                                <input type="hidden" name="type" id="request_type" value="{{ old('type') ?? '' }}" required>
                                <button type="button" id="request_type_select_trigger"
                                    class="kt-input w-full text-left flex items-center justify-between cursor-pointer">
                                    <span
                                        id="request_type_select_text">{{ old('type') ? (old('type') === 'GENERAL' ? 'General Manning Level (HRD) - All Ranks' : 'Zone Manning Level (Zone Coordinator) - GL 7 and Below Only') : 'Select Request Type' }}</span>
                                    <i class="ki-filled ki-down text-gray-400"></i>
                                </button>
                                <div id="request_type_dropdown"
                                    class="absolute z-50 w-full mt-1 bg-white border border-input rounded-lg shadow-lg hidden">
                                    <div class="p-3 border-b border-input">
                                        <input type="text" id="request_type_search_input" class="kt-input w-full pl-10"
                                            placeholder="Search request type..." autocomplete="off">
                                    </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex items-center justify-between">
                            <label class="kt-form-label font-normal text-mono">Request Items <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <textarea class="kt-input" placeholder="Additional notes or remarks" name="notes"
                            rows="4"></textarea>
                    </div>
                </div>
