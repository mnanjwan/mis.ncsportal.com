    ...
    <div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="kt-card">
            ...
            <div class="kt-card-content">
                ...
                <form action="{{ route(($routePrefix ?? 'hrd') . '.movement-orders.store') }}" method="POST" id="movement-order-form">
                    @csrf
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4 border-t border-border">
                            <a href="{{ route(($routePrefix ?? 'hrd') . '.movement-orders') }}" class="kt-btn kt-btn-secondary">
                                Cancel
                            </a>
