...
@section('title', 'Print Leave Application')

@section('content')
<div class="max-w-4xl mx-auto p-8 bg-white">
    <div class="text-center mb-8">
        <h1 class="text-2xl font-bold">NIGERIA CUSTOMS SERVICE</h1>
        <h2 class="text-xl font-semibold mt-2">Leave Application</h2>
    </div>
    
    @php
        $application = \App\Models\LeaveApplication::with(['officer', 'leaveType'])->findOrFail($id);
    @endphp
    ...
    <div class="space-y-6">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <p class="font-semibold">{{ $application->leaveType->name ?? 'N/A' }}</p>
            </div>
            <div>
