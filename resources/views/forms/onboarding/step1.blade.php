...
<div class="grid gap-5 lg:gap-7.5">
        ...
        <div class="kt-card-content p-5">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    <div class="size-8 rounded-full bg-primary text-white flex items-center justify-center font-semibold">1</div>
                    <span class="text-sm font-medium">Personal Information</span>
                </div>
                <div class="flex items-center gap-2">
                    <div class="size-8 rounded-full bg-muted text-secondary-foreground flex items-center justify-center font-semibold">2</div>
                    <span class="text-sm text-secondary-foreground">Employment Details</span>
                </div>
                <div class="flex items-center gap-2">
    ...
    <div class="kt-card">
        ...
        <div class="kt-card-content">
            ...
            <form id="onboarding-step1-form" method="POST" action="{{ route('onboarding.step1.save') }}" class="flex flex-col gap-5">
                @csrf
                
                <div class="grid lg:grid-cols-2 gap-5">
                    <div class="flex flex-col gap-1">
                        <label class="kt-form-label">Service Number</label>
                        <input type="text" name="service_number" class="kt-input" value="{{ old('service_number', $savedData['service_number'] ?? '') }}" readonly/>
                ...
                <div class="flex items-center justify-end gap-3 pt-5 border-t border-input">
                    <a href="{{ route('hrd.dashboard') }}" class="kt-btn kt-btn-secondary">Cancel</a>
                    <button type="submit" class="kt-btn kt-btn-primary">Next: Employment Details</button>
                </div>
            </form>
        </div>
    </div>
