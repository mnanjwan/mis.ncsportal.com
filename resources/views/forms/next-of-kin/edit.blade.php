...
@section('page-title', 'Edit Next of KIN')
...
@section('content')
    ...
    <div class="grid gap-5 lg:gap-7.5">
            ...
            <div class="kt-card-content">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-sm font-semibold text-foreground mt-1">{{ $nextOfKin->name }}</p>
                    </div>
                    <div>
                        <span class="text-sm text-secondary-foreground">Relationship</span>
                        <p class="text-sm font-semibold text-foreground mt-1">{{ $nextOfKin->relationship }}</p>
                    </div>
                    <div>
                        <span class="text-sm text-secondary-foreground">Phone Number</span>
                        <p class="text-sm font-semibold text-foreground mt-1">{{ $nextOfKin->phone_number ?? '—' }}</p>
                    </div>
                    <div>
                        <span class="text-sm text-secondary-foreground">Email</span>
                        <p class="text-sm font-semibold text-foreground mt-1">{{ $nextOfKin->email ?? '—' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="kt-card">
            <div class="kt-card-header">
                <h3 class="kt-card-title">Edit Next of KIN</h3>
            </div>
            <div class="kt-card-content">
                <form action="{{ route('officer.next-of-kin.update', $nextOfKin->id) }}" method="POST" id="editForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   id="phone_number" 
                                   name="phone_number" 
                                   value="{{ old('phone_number', $nextOfKin->phone_number) }}"
                                   class="kt-input w-full" 
                        ...
                        <div>
                            ...
                            <input type="email" 
                                   id="email" 
                                   name="email" 
                                   value="{{ old('email', $nextOfKin->email) }}"
                                   class="kt-input w-full" 
                        ...
                        <div>
                            ...
                            <textarea id="address" 
                                      ...
                                      rows="4"
                                      class="kt-input w-full"
                                      placeholder="Enter address">{{ old('address', $nextOfKin->address) }}</textarea>
                        </div>
                        ...
                        <div>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" 
                                       ...
                                       value="1" 
                                       class="kt-checkbox"
                                       {{ old('is_primary', $nextOfKin->is_primary) ? 'checked' : '' }}>
