...
<body>
    ...
    <div class="header">
        ...
        <h1>FINAL STATUTORY RETIREMENT LIST FOR {{ $list->year ?? 'N/A' }}</h1>
    </div>
        ...
        <tbody>
            @foreach($items as $item)
                <tr>
                    ...
                    <td>{{ $item['date_of_pre_retirement_leave'] ? \Carbon\Carbon::parse($item['date_of_pre_retirement_leave'])->format('d/m/Y') : 'N/A' }}</td>
                    <td>{{ $item['retirement_date'] ? \Carbon\Carbon::parse($item['retirement_date'])->format('d/m/Y') : 'N/A' }}</td>
                    <td></td>
                </tr>
            @endforeach
        </tbody>
