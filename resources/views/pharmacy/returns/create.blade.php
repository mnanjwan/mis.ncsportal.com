...
@section('page-title', 'Initiate Stock Return')
...
@section('breadcrumbs')
    ...
    <span class="text-muted-foreground">/</span>
    <span class="text-muted-foreground">Initiate Return</span>
@endsection
    ...
    <div class="kt-container-fixed">
        <div class="kt-card max-w-4xl mx-auto overflow-hidden">
            <div class="kt-card-header py-4">
                <h3 class="kt-card-title text-xl font-bold">Initiate Stock Return</h3>
                <p class="text-sm text-secondary-foreground mt-1">Select items and quantities to return to Central Medical Store.</p>
            </div>
            <div class="kt-card-content p-6">
                <form action="{{ route('pharmacy.returns.store') }}" method="POST" id="return-form">
                    @csrf
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="notes" id="notes" rows="3" 
                                  ...
                                  placeholder="e.g., Short-dated stock, Surplus, Recalled items..."></textarea>
                    </div>
                    ...
                    <div class="mt-10 pt-6 border-t border-border flex items-center justify-end gap-3">
                        <a href="{{ route('pharmacy.returns.index') }}" class="kt-btn kt-btn-ghost">Cancel</a>
                        <button type="submit" class="kt-btn kt-btn-primary px-8">Create Return Draft</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function addItem() {
                ...
                // Update IDs and names with index
                ...
                removeBtn.addEventListener('click', function() {
                    if (container.querySelectorAll('.item-row').length > 1) {
                        actualRow.classList.add('scale-95', 'opacity-0');
                        setTimeout(() => actualRow.remove(), 200);
                    }
                });
