...
return new class extends Migration
{
    ...
    {
        Schema::create('pass_approvals', function (Blueprint $table) {
            $table->id();
            $table->foreignId('pass_application_id')->unique()->constrained('pass_applications')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('pass_approvals');
    }
};
